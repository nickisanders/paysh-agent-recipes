...
| [⚡ Realtime Whale Watcher](./realtime-whale-watcher) | Follows the chain head and pushes a Telegram alert within ~one block of a whale-sized transfer | pay.sh JSON-RPC · Telegram · long-running | _soon_ |
